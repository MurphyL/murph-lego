...
(function () {
  var LegoApp = /*#__PURE__*/function (_HTMLElement) {
    _inherits(LegoApp, _HTMLElement);

    var _super = _createSuper(LegoApp);

    function LegoApp() {
      var _this;

      _classCallCheck(this, LegoApp);

      _this = _super.call(this);

      if (!_this.hasAttribute('manifests')) {
    ...
    _createClass(LegoApp, [{
      key: "connectedCallback",
      value: function connectedCallback() {
        var axios = require('axios');

        axios.get(this.getAttribute('manifests')).then(function (_ref) {
